...
export default async function HomePage() {
  ...
  const getProjectImage = (title: string) => {
    ...
    if (t.includes('blogsphere') || t.includes('blog sphere'))
    ...
    if (t.includes('portfolio'))
      return 'https://res.cloudinary.com/dkkf4schl/image/upload/v1777972587/potfolio_tthmwf.png'
    if (t.includes('prestige'))
          ...
          {projects?.map((project: any) => (
            ...
            >
              ...
              {project?.id ? (
                ...
                <button
                  disabled
                  className="text-xs px-6 py-2 border border-gray-500 text-gray-500 rounded-full cursor-not-allowed"
                >
                  No Details
                </button>
              )}
