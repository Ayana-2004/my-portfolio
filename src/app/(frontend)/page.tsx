...
export default async function ProjectDetails({ params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#030812] text-white text-center px-6">
        <div>
          <h1 className="text-3xl font-bold text-[#FFD700] mb-4">Project not available</h1>

          <a href="/#projects" className="text-[#FFD700] underline">
            Back to Projects
          </a>
        </div>
      </div>
